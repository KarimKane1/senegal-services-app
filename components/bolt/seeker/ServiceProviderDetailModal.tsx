...
export default function ServiceProviderDetailModal({ provider, onClose }: ServiceProviderDetailModalProps) {
  ...
  const handleWhatsAppContact = async () => {
    if (detail.whatsapp_intent) {
      window.open(`${detail.whatsapp_intent}?text=${encodeURIComponent(`Hi ${provider.name}, I found you through Trust Network and would like to inquire about your ${provider.serviceType.toLowerCase()} services.`)}`, '_blank');
      return;
    }
