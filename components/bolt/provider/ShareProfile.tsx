...
export default function ShareProfile() {
  ...
  const handleShareWhatsApp = () => {
    const message = `Hi! I'm John the Plumber. If you've used my services and were satisfied, please add me to your Lumio recommendations using this link: ${profileUrl}`;
