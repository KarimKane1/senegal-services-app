...
// Mock data for the connection's recommendations
const mockConnectionRecommendations: ServiceProvider[] = [
  {
    id: '1',
...
export default function ConnectionProfile({ connection, onBack }: ConnectionProfileProps) {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="mb-6">
        <h2 className="text-xl font-bold text-gray-900 mb-2">Their Trusted Providers</h2>
        <p className="text-gray-600">Service providers recommended by {connection.name}</p>
      </div>

      {/* Providers List */}
      <div className="space-y-6">
        {mockConnectionRecommendations.map((provider) => (
          <div 
            key={provider.id} 
          ...
          >
            <div className="flex items-start justify-between mb-4">
              <div>
                ...
                <p className="text-indigo-600 font-medium mb-2">{provider.serviceType}</p>
            ...
            {provider.qualities.length > 0 && (
              <div className="mb-4">
                <p className="text-xs text-gray-500 uppercase tracking-wide mb-2">What {connection.name} Liked</p>
