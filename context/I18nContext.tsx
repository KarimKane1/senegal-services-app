...
const en: Messages = {
  ...
  'landing.tagline': 'Digitizing trust through verified recommendations. Connect with reliable service providers through Verra.',
  'landing.trusted': 'Verra Networks',
  ...
  'landing.verifiedText': 'Get recommendations from people you trust in Verra',
  'landing.quick': 'Quick Connect',
  'landing.quickText': 'Instantly connect with service providers via WhatsApp',
  'landing.getStarted': 'Get Started',
  'landing.getStartedText': 'Join Verra to get started',
  'landing.browseGuest': 'Browse as Guest',
  'connections.title': 'Your Friends',
  'connections.subtitle': 'Connect with people you trust to discover and share reliable service provider recommendations. Build your network on Verra to access verified contacts and help others find great services.',
  ...
  'recs.addSubtitle': 'Know a great service provider? Share them with your network on Verra',
  ...
  'profile.subtitle': 'Your Verra profile and settings',
  ...
  'onboard.seeker.welcome.title': 'Welcome to Verra! 👋',
  'onboard.seeker.welcome.desc': 'Let\'s take a quick tour to show you how to find trusted service providers through your network on Verra.',
  'onboard.seeker.connections-tab.title': 'Start with Connections',
  'onboard.seeker.connections-tab.desc': 'This is where you build your network on Verra. Connect with friends and family to access their recommendations.',
  ...
  'onboard.seeker.click-connections.desc': 'Click on any person to see the service providers they recommend. This is the core of Verra!',
  'onboard.seeker.services-tab.title': 'Find Service Providers',
  'onboard.seeker.services-tab.desc': 'Switch to Services to browse providers recommended by your network on Verra.',
  ...
  'onboard.seeker.recommendations-tab.desc': 'Know a great service provider? Add them here to help your network on Verra!',
  'onboard.seeker.add-recommendation-button.title': 'Add Service Providers',
  'onboard.seeker.add-recommendation-button.desc': 'Click here to add a trusted service provider to your recommendations and share them with your network on Verra.',
  ...
  'onboard.provider.welcome.title': 'Welcome to Verra! 👋',
  ...
  'onboard.provider.share-profile.desc': 'Share your profile so others can recommend you to their network on Verra.',
  'role.seeker': 'Seeker',
...
const fr: Messages = {
  ...
  'landing.tagline': 'Digitaliser la confiance grâce aux recommandations vérifiées. Connectez-vous à des prestataires fiables via Verra.',
  'landing.trusted': 'Réseaux Verra',
  'landing.trustedText': 'Développez votre réseau de prestataires et de connexions',
  'landing.verified': 'Recommandations vérifiées',
  'landing.verifiedText': 'Recevez des recommandations de personnes de confiance sur Verra',
  'landing.quick': 'Connexion rapide',
  'landing.quickText': 'Contactez instantanément via WhatsApp',
  'landing.getStarted': 'Commencer',
  'landing.getStartedText': 'Rejoignez Verra pour commencer',
  'landing.browseGuest': 'Parcourir en invité',
  'connections.title': 'Vos amis',
  'connections.subtitle': 'Connectez-vous avec des personnes de confiance pour découvrir et partager des recommandations de prestataires fiables. Construisez votre réseau sur Verra pour accéder aux contacts vérifiés et aider les autres à trouver de bons services.',
...
const wo: Messages = {
  ...
  'landing.tagline': 'Ñu digitalise wóor te mën a gëm. Jokk ak sarwiiser yu wér ci Verra.',
  'landing.trusted': 'Réseau Verra',
  'landing.trustedText': 'Yokk sa réseauu sarwiiser ak mbokk',
  'landing.verified': 'Ndigaal yu wóor',
  'landing.verifiedText': 'Jël ndigaal ci nit ñi nga gëm ci Verra',
  'landing.quick': 'Jokkoo gaaw',
  'landing.quickText': 'Jokkofal ci WhatsApp leegi',
  'landing.getStarted': 'Tambali',
  'landing.getStartedText': 'Bokk ci Verra ngir tambali',
  'landing.browseGuest': 'Saytu niki dëkkandoo',
  'connections.title': 'Say xarit',
  'connections.subtitle': 'Jokkoo ak nit ñi nga gëm ngir gis te bokk ndigaal yu wér ci sarwiis. Yokk sa xarit ci Verra ngir am luñu gëm te dimbali yeneen ngir gis sarwiis yu baax.',
  ...
  'onboard.seeker.welcome.title': 'Nuyoo ci Verra! 👋',
  ...
  'onboard.provider.welcome.title': 'Nuyoo ci Verra! 👋',
