...
const en: Messages = {
  ...
  'connections.title': 'Your Network',
  'connections.subtitle': "Your trusted network and their recommendations",
  ...
  'onboard.seeker.welcome.title': 'Welcome to Trust Network! 👋',
  ...
  'onboard.provider.welcome.title': 'Welcome to Trust Network! 👋',
...
const fr: Messages = {
  'app.title': 'Réseau de Confiance',
  'nav.connections': 'Réseau',
  'nav.services': 'Services',
  ...
  'landing.tagline': 'Digitaliser la confiance grâce aux recommandations vérifiées. Connectez-vous à des prestataires fiables via votre réseau.',
  'landing.trusted': 'Réseaux de confiance',
  ...
  'landing.getStartedText': 'Rejoignez le réseau ou naviguez en invité',
  'landing.browseGuest': 'Parcourir en invité',
  'connections.title': 'Votre réseau',
  'connections.subtitle': 'Votre réseau de confiance et leurs recommandations',
  'connections.findPeople': 'Trouver des personnes',
  'connections.requests': 'Demandes',
  'connections.grow': 'Développez votre réseau',
  ...
  'profile.yourNetwork': 'Votre réseau',
  'profile.connections': 'Réseau',
  ...
  'category.cleaner': 'Femme/Homme de ménage',
  'category.tech_repair': 'Réparation tech',
  ...
  'services.recommendedByNetwork': 'personnes de votre réseau',
  'services.recommendedByOne': 'personne de votre réseau',
...
const wo: Messages = {
  ...
  'landing.tagline': 'Ñu digitalise wóor te mën a gëm. Jokk ak sarwiiser yu wér ci sa mbokk.',
  'landing.trusted': 'Réseau yu wér',
  'landing.trustedText': 'Yokk sa réseauu sarwiiser ak mbokk',
  'landing.verified': 'Ndigaal yu wóor',
  'landing.verifiedText': 'Jël ndigaal ci nit ñi nga gëm',
  'landing.quick': 'Jokkoo gaaw',
  'landing.quickText': 'Jokkofal ci WhatsApp leegi',
  'landing.getStarted': 'Tambali',
  'landing.getStartedText': 'Bokk ci réseau bi walla saytu niki dëkkandoo',
  'landing.browseGuest': 'Saytu niki dëkkandoo',
  'connections.title': 'Sa réseau',
  'connections.subtitle': 'Sa réseau yu wér ak seen ndigaal yi',
  ...
  'onboard.seeker.welcome.title': 'Nuyoo ci Trust Network! 👋',
  ...
  'onboard.provider.welcome.title': 'Nuyoo ci Trust Network! 👋',
