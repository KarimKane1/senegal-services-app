    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">Manage and view all platform users</p>
        </div>
                  ...
                  {users.map((user) => (
                    <tr key={user.id} className="hover:bg-gray-50">
                        ...
                        <div className="flex items-center">
                          <div className="w-10 h-10 rounded-full bg-indigo-100 flex items-center justify-center text-indigo-600 font-semibold mr-3">
                            {user.photo_url?.startsWith('emoji:') ? (
                              <span className="text-lg">{user.photo_url.replace('emoji:', '')}</span>
                            ) : user.photo_url ? (
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        ...
                        <div className="text-sm text-gray-500">{maskPhone(user.phone_e164)}</div>
                      </td>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-800">
                          {user.language === 'fr' ? 'Français' : user.language === 'wo' ? 'Wolof' : 'English'}
                        </span>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
